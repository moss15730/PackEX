...
==================================================
PackEye เป็นระบบบันทึกวิดีโอตอนบรรจุพัสดุ (packing) เพื่อเก็บเป็นหลักฐานต่อออเดอร์
...
5. มีชั้น Platform สำหรับทีม PackEye ดูแลลูกค้า/แพ็กเกจ/ซัพพอร์ต

==================================================
1) โมเดลธุรกิจและการขาย
==================================================
- PackEye เป็นแพลตฟอร์มกลางที่ผู้ขายระบบเป็นเจ้าของ
- ลูกค้าแต่ละราย = 1 Tenant (บริษัท/โกดัง) แยกข้อมูล 100%
- เข้าใช้ผ่าน subdomain หรือ path แยก tenant เช่น:
  - acme.packeye.app
  - app.packeye.com/t/acme
- รองรับ custom domain ในแพ็กเกจ Enterprise

ผู้ดูแล 2 ระดับ:
A) Platform Super Admin (ทีม PackEye)
...
-------------------------
4.13 Platform Admin (ฝั่ง PackEye)
-------------------------
...
==================================================
สร้าง PackEye Station Agent สำหรับเครื่องที่สถานีแพ็ค:
...
- มีแบรนด์ PackEye ชัดใน sidebar/header
...
เป้าหมายสูงสุด:
ได้ระบบ PackEye ที่พร้อมใช้ในโกดังจริง และพร้อมขายให้หลายลูกค้า
